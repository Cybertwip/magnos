...
macro(search_openblas version)
  ...
  if (NOT BLAS_FOUND OR (NOT BLAS_LIBRARIES))
    ...
    if (NOT MSVC)
      if (NOT EXISTS "${CMAKE_BINARY_DIR}/deps/OpenBLAS-${version}/libopenblas.a")
        if(EMSCRIPTEN)
          execute_process(COMMAND NOFORTRAN=1 GEMM_MULTITHREAD_THRESHOLD=4 emmake make TARGET=GENERIC NO_SHARED=1
  ...
  if(EMSCRIPTEN)
    set(GFORTRAN "" CACHE STRING "GFORTRAN")
    set(PTHREAD "" CACHE STRING "PTHREAD")
  else()
