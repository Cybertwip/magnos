...
public:
	...
	AtrousConvolution(const AtrousConvolution& layer);
	//! Take ownership of another ConstantType.
	AtrousConvolution(AtrousConvolution&& layer);
	//! Copy another ConstantType.
	AtrousConvolution& operator=(const AtrousConvolution& layer);
	//! Take ownership of another ConstantType.
	AtrousConvolution& operator=(AtrousConvolution&& layer);
